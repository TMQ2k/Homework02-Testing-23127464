...
export default function ForgotPassword() {
  ...
  const handleRequest = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post('https://eshop-backend-api.onrender.com/api/forgot-password', { email });
  ...
  const handleReset = async (e) => {
    ...
    try {
      await axios.post('https://eshop-backend-api.onrender.com/api/reset-password', { email, resetToken, newPassword });
